 ...
 const AskBibleFloat = () => {
   ...
   return (
     <button
       ...
       className="fixed bottom-24 right-5 z-50 w-14 h-14 rounded-2xl overflow-hidden shadow-lg active:scale-95 transition-all animate-fade-in border border-white/10"
