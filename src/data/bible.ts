...
export const readingPlans: ReadingPlan[] = [
  {
    ...
    image: "📖",
    readings: [
      { bookAbbrev: "gn", chapter: 1 }, { bookAbbrev: "gn", chapter: 2 }, { bookAbbrev: "gn", chapter: 3 },
    ],
  },
  {
    id: "2",
    title: "Salmos de Conforto",
    description: "30 dias nos Salmos que trazem paz",
    days: 30,
    category: "Devocionais",
    image: "🕊️",
    readings: [
      { bookAbbrev: "sl", chapter: 23 }, { bookAbbrev: "sl", chapter: 27 }, { bookAbbrev: "sl", chapter: 34 },
      { bookAbbrev: "sl", chapter: 46 }, { bookAbbrev: "sl", chapter: 91 }, { bookAbbrev: "sl", chapter: 121 },
    ],
  },
  {
    id: "3",
    title: "Vida de Jesus",
    description: "Conheça Jesus nos 4 Evangelhos",
    days: 40,
    category: "Temáticos",
    image: "✝️",
    readings: [
      { bookAbbrev: "mt", chapter: 1 }, { bookAbbrev: "mt", chapter: 5 }, { bookAbbrev: "mc", chapter: 1 },
      { bookAbbrev: "lc", chapter: 1 }, { bookAbbrev: "jo", chapter: 1 },
    ],
  },
  {
    id: "4",
    title: "Provérbios em 31 Dias",
    description: "Um capítulo por dia de sabedoria",
    days: 31,
    category: "Sabedoria",
    image: "💡",
  ...
  },
  {
    ...
    description: "Explore as epístolas paulinas",
    days: 60,
    category: "Estudo",
    image: "📜",
    readings: [
      { bookAbbrev: "rm", chapter: 1 }, { bookAbbrev: "1co", chapter: 1 }, { bookAbbrev: "gl", chapter: 1 },
      { bookAbbrev: "ef", chapter: 1 }, { bookAbbrev: "fp", chapter: 1 },
    ],
  },
  {
    id: "6",
    title: "Gênesis a Apocalipse",
    description: "Os grandes marcos da história bíblica",
    days: 90,
    category: "Panorama",
    image: "🌍",
    readings: [
      { bookAbbrev: "gn", chapter: 1 }, { bookAbbrev: "gn", chapter: 12 }, { bookAbbrev: "ex", chapter: 1 },
      { bookAbbrev: "js", chapter: 1 }, { bookAbbrev: "mt", chapter: 1 }, { bookAbbrev: "ap", chapter: 1 },
    ],
  },
];
