        ...
        <div className="pb-20 min-h-screen">
          ...
          <div className="px-5 space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 rounded-2xl py-3.5 font-semibold text-sm active:opacity-90 transition-opacity"
            >
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-[hsl(var(--dark-card))]" />
              <span className="text-xs text-[hsl(var(--dark-muted))]">ou</span>
              <div className="flex-1 h-px bg-[hsl(var(--dark-card))]" />
            </div>
