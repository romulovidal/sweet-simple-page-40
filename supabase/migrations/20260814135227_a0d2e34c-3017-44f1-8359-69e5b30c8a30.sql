...
-- 11. HELPER: PARSE TIME (Temporário para seed)
...
VALUES 
    ('system:welcome', 'Mensagem de Boas-vindas', 'welcome', 'automatic', '{ "00:00" }'), 
    ...
    ('system:plans', 'Orquestração de Planos de Leitura', 'plan-reading', 'automatic', '{ "05:00" }'),
    ('system:series', 'Orquestração de Séries Temáticas', 'series', 'automatic', '{ "06:00" }'),
    ('system:broadcasts', 'Envios de Transmissão', 'broadcast', 'manual', '{ "00:00" }'),
