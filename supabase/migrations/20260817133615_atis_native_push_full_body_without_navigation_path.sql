...
begin
  ...
  if char_length(_body) > 4096 then
    raise exception 'ATIS native push body exceeds 4096 characters';
  end if;
  ...
  -- PWA/internal navigation routes are metadata only. They must never be
  -- rendered as visible WhatsApp content.
